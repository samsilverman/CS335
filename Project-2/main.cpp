// This program sorts a table of ten numbers passed from C using 
// assembly language, and display the outer loop counter using the 
// lights and an appropriate delay. A simple insersion sort was
...
// C version of soft function, to test algorithm and driver
void c_sort (int numbers[16], int size) {
    int temp;
